...
4. **UI polish** — stabilize tab interactions, add zoom/selection/decimation controls that reuse the shared `Figure`, cache derived curves across tabs, and surface more HRV/EEG/eye metrics in the dashboard.
